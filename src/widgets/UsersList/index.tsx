...
/**
 * Компонент отображения списка пользователей в виде таблицы.
 *
 * Загружает пользователей с сервера при монтировании, отображает их данные
 * в табличной форме с возможностью редактирования и удаления.
 *
 * Использует `UpdateUserButton` и `DeleteUserButton` для управления действиями над пользователем.
 * Пользователь с `id = "1"` (Админ) не может быть удалён.
 */
